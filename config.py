...
TRANSLATIONS = {
    "ar": dict(sorted({
        ...
        "finished": "انتهت ✓",
        "free_for_the_sake_of_allah": "مجاناً لوجه الله تعالى",
        "general": "عام",
        "hour": "ساعة",
        "isha": "العشاء",
        ...
        "no_sound_file_selected": "لم يتم تحديد ملف صوتي",
        "failed_to_play_sound": "فشل في تشغيل الصوت",
        "notifications": "الإشعارات",
        "notification_before_prayer": "الإشعار قبل الأذان (دقائق)",
        "notification_sound_file": "ملف صوت التنبيه",
        "notification_settings_for_each_prayer": "إعدادات الإشعارات لكل صلاة",
        "now": "الآن ⏰",
        "play": "تشغيل",
    ...
    "en": dict(sorted({
        ...
        "failed_to_play_sound": "Failed to play sound",
        "notifications": "Notifications",
        "notification_before_prayer": "Notify before prayer (minutes)",
        "notification_sound_file": "Notification Sound File",
        "notification_settings_for_each_prayer": "Notification Settings for Each Prayer",
        "now": "Now ⏰",
        "play": "Play",
